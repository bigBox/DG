...
@ccclass
export default class TownMap1002 extends TownMapBase {
    Timearray: any[];
    ...
    dealFactoryEvent(factoryData, touchPoint) {
        global.Instance.Log.debug('dealFactoryEvent',factoryData)
         if (factoryData.key == 'bailemen' || factoryData.key == 'yuyuan' || factoryData.key == 'shiliu'||factoryData.key == 'saima') {
    ...
    visitNpc(factoryData, touchPoint) {
        ...
        let npcTalkEnd1 = function (params,msg) {
             params.stage = 2;
            ...
            } else if(params.eventType == 105){
                global.Manager.UIManager.open('UIRobbery', null, function (panel) {
                    if (panel == null) {
                        return;
                    }
                    panel.show(params, msg, npcThingsEnd);
                });
            }
        }.bind(this);
            ...
            let params = {
                ...
                if (msg.eventType == 100) {
                    ...
                    global.Manager.UIManager.open('UITownNpcTalk', null, function (panel) {
                        if (panel == null)
                            return;
                        panel.show(params, msg.eventType==105, npcTalkEnd1);
                    }.bind(this));
                }
