    ...
    "messages": [
        {
            ...
            "options": {
                ...
                "java_package": "com.dj.protobuf.manufacture"
            },
            "messages": [
                {
                    "name": "DateTime",
                ...
                {
                    "name": "ManufactureActionReq",
                    "syntax": "proto2",
                    "fields": [
                        {
                            "rule": "optional",
                            "type": "EManufactureActionType",
                            "name": "actionType",
                            "id": 1
                        },
                        {
                ...
                },
                {
                    ...
                    "fields": [
                        ...
                        },
                        {
                            "rule": "optional",
                            "type": "int32",
                            "name": "produceItemCount",
                            "id": 4
                        }
                    ]
                },
                {
                    "name": "ManufactureInfoReq",
                    "syntax": "proto2",
                    "fields": []
                },
                {
                    "name": "ManufactureInfoRsp",
                    "syntax": "proto2",
                    "fields": [
                        {
                            "rule": "repeated",
                            "type": "ManufactureState",
                            "name": "items",
                            "id": 1
                        },
                        {
                ...
                {
                    "name": "ManufactureBatchPickupReq",
                    "syntax": "proto2",
                    "fields": [
                        {
                            "rule": "optional",
                ...
                {
                    "name": "ManufactureBatchPickupRsp",
                    "syntax": "proto2",
                    "fields": [
                        {
                            "rule": "optional",
