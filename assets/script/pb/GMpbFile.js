    ...
    "messages": [
        {
            ...
            "options": {
                ...
                "java_package": "com.dj.protobuf.gm"
            },
            "messages": [
                {
                    "name": "BaseRoleInfo",
                ...
                {
                    "name": "ItemInteractHistory",
                    "syntax": "proto2",
                    "fields": [
                        {
                            "rule": "optional",
                            "type": "BaseRoleInfo",
                            "name": "interactRoleInfo",
                            "id": 1
                        },
                        {
                            "rule": "optional",
                ...
                {
                    "name": "ItemInteractHistoryReq",
                    "syntax": "proto2",
                    "fields": []
                },
                {
                    "name": "ItemInteractHistoryRsp",
                    "syntax": "proto2",
                    "fields": [
                        {
                            "rule": "optional",
                        ...
                        {
                            "rule": "optional",
                            "type": "ItemInteractHistoryReq",
                            "name": "req",
                            "id": 2
                        },
                        {
                            "rule": "repeated",
                            "type": "ItemInteractHistory",
                            "name": "histories",
                            "id": 3
                        }
                    ]
                ...
                {
                    "name": "GmShutdownCmdRsp",
                    "syntax": "proto2",
                    "fields": [
                        {
                            "rule": "optional",
                            "type": "GmShutdownCmdReq",
                            "name": "req",
                            "id": 1
                        },
                        {
