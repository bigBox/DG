    ...
    "messages": [
        {
            ...
            "options": {
                ...
                "java_package": "com.dj.protobuf.summon"
            },
            "messages": [
                {
                    "name": "DateTime",
                ...
                {
                    "name": "SummonAllMailRewardReq",
                    "syntax": "proto2",
                    "fields": []
                },
                {
                    "name": "SummonAllMailRewardRsp",
                    "syntax": "proto2",
                    "fields": [
                        {
                            "rule": "optional",
                ...
                {
                    "name": "SummonNewMailReq",
                    "syntax": "proto2",
                    "fields": []
                },
                {
                    "name": "SummonNewMailRsp",
                    "syntax": "proto2",
                    "fields": [
                        {
                            "rule": "optional",
                ...
                {
                    "name": "SummonPickupInvestRewardReq",
                    "syntax": "proto2",
                    "fields": [
                        {
                            "rule": "optional",
                ...
                {
                    "name": "SummonPickupInvestRewardRsp",
                    "syntax": "proto2",
                    "fields": [
                        {
                            "rule": "optional",
                        ...
                        {
                            "rule": "optional",
                            "type": "SummonPickupInvestRewardReq",
                            "name": "req",
                            "id": 2
                        },
                        {
